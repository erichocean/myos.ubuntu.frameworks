...
id _UISegmentedControlMetaValueForKey(UISegmentedControl* segmentedControl, NSString* key, NSUInteger index)
{
...
void _UISegmentedControlSetMetaValue:(UISegmentedControl* segmentedControl, id value, NSString* key, NSUInteger index)
{
    NSMutableDictionary *meta = [self _metaForSegmentIndex:index];
    if (!meta) {
