...
- (void) finishLaunching
{
  ...
  //DLog(@"_key_window: %@", _key_window);
  //DLog(@"_main_window: %@", _main_window);
...
- (void) run
{
  ...
  DLog(@"NSApp run distantFuture: %@", distantFuture);
  ...
  while (_app_is_running)
    {
      ...
      //NSLog(@"NSApp run - _app_is_running, e: %@", e);
      if (e != nil)
	{
	  NSEventType	type = [e type];

          //NSLog(@"NSApp run - _app_is_running, e != nil, type: %d", type);
