...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    gradients2 = [[[GradientsView alloc] initWithFrame:CGRectMake(x+15,y-70,width-30,150)] autorelease];
    [window addSubview:gradients2];
    gradients2 = [[[GradientsView alloc] initWithFrame:CGRectMake(x+95,y+height-180,width-170,50)] autorelease];
    [window addSubview:gradients2];

    gradients2 = [[[GradientsView alloc] initWithFrame:CGRectMake(25,50,width-50,100)] autorelease];
